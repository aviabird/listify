export interface FacebookInitParams {
     ...
     * or go there to create a new app. Defaults to null.
     */
    appId?: string;
    ...
    /**
     * Determines whether the current login status of the user is freshly retrieved on every page load. If this is disabled,
    ...
    /**
     * Frictionless Requests are available to games on Facebook.com or on mobile web using the JavaScript SDK.
     * This parameter determines whether they are enabled. 
     * Defaults to false.
     */
    frinctionlessRequests?: boolean;
     ...
     * as Flash objects will always have a higher z-index than any other 
     * DOM element.
     * Defaults to null. 
     */
